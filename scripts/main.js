...
class Juego {
    ...
    cambiarNivel() {
        if (this.nivel === 1) {
            ...
            swal('Buen trabajo', `Haz completado el nivel ${this.nivel - 1}`, 'success')
        ...
        if (numeroColor === this.secuencia[this.subnivel]) {
            ...
            if (this.subnivel === this.nivel) {
                ...
                if (this.nivel === (ULTIMO_NIVEL + 1)) {
                    ...
                    //swal('Bien', 'Pasate el nivel', 'success')
                    setTimeout(this.cambiarNivel(), 1500)
                }
            }
        } else {
            // Perdió!
    ...
    perdioElJuego() {
        swal('Ni modo', 'Lo siento perdiste :(', 'error')
        .then(() => {
            this.eliminarEventosClick()
            this.inicializar()
        })
